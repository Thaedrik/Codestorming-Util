...
public class IOUtil {
	 ...
	 */
	public static String createStringFromInputStream(InputStream inputStream, String charsetName)
	...
	/**
	 * Creates a {@code String} with an {@link InputStream}.<br>
	 * (Use the default system charset for decoding the byte stream).
	 * 
	 * @param inputStream {@code InputStream} from which to create the String.
	 * @return the {@code String} created with the given {@link InputStream}.
	 * @throws IOException If a problem occurs while reading the {@link InputStream}.
